...
public class CRUDEstadioForm extends JFrame {
    ...
    public CRUDEstadioForm() {
        ...
        tabbedPane.addTab("🏟️ Gestión de Estadios", crearPanelEstadios());
        tabbedPane.addTab("🏙️ Gestión de Ciudades Anfitrionas", crearPanelCiudades());
    ...
    private JPanel crearPanelEstadios() {
        ...
        JButton btnEliminar = crearBotonNativo("🗑️ Eliminar Instalación", new Color(140, 40, 40));
    ...
    private JPanel crearPanelCiudades() {
        ...
        JButton btnEliminar = crearBotonNativo("🗑️ Eliminar Ciudad", new Color(140, 40, 40));
    ...
    private JPanel crearPanelPaises() {
        ...
        JButton btnEliminar = crearBotonNativo("🗑️ Eliminar País", new Color(140, 40, 40));
